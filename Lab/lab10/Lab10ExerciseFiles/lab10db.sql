/* COMP 3311 Lab 10 Exercise: lab10db.sql */

clear screen
set feedback off
set heading off
select '*** Creating Lab 10 database ***' from dual;
set heading on
...
create table AcademicUnit (
	...
	unitName	varchar(50),
	roomNo      char(4),
    constraint CHK_unitId check (unitId in ('COMP', 'ELEC','FINA', 'HUMA', 'MATH', 'MGMT')));
...
create table Course (
    ...
    unitId      char(4) not null references AcademicUnit(unitId) on delete cascade,
...
create table Student (
    ...
    cga         number(3,2) check (cga between 0.00 and 4.00),
	unitId      char(4) not null references AcademicUnit(unitId) on delete cascade,
    ...
    constraint CHK_admitYear check (regexp_like(rtrim(admitYear), '^2[0-9]{3}$')));

create table EnrollsIn (
 	studentId	char(8) references Student(studentId) on delete cascade,
	courseId	char(9) references Course(courseId) on delete cascade,
	grade		number(4,1),
...
insert into Student values ('13455789','Harry','Potter','cspotter','23581234','2023',null,'COMP');
insert into Student values ('15456789','Leo','Da Vinci','csdavinci','23585678','2023',null,'COMP');
insert into Student values ('13556789','Leo','Greenleaf','magreenleaf','23582468','2024',null,'MATH');
insert into Student values ('13456789','Ariana','Grande','csgrande','23581234','2024',null,'COMP');
insert into Student values ('15678989','Edith','Clarke','csclarke','23589876','2024',null,'COMP');
insert into Student values ('15678901','Albert','Einstein','cseinstein','23585678','2023',null,'COMP');
insert into Student values ('16789012','Robert','Redford','maredford','23582468','2024',null,'MATH');
insert into Student values ('14567890','David','Decker','eedecker','23589876','2024',null,'ELEC');
insert into Student values ('99987654','Lazzy','Lazy','cslazy','23581357','2024',null,'COMP');
insert into Student values ('26184624','Bruce','Wayne','eewayne','28261057','2023',null,'ELEC');
insert into Student values ('26184444','Donald','Trump','bstrump','28255057','2024',null,'MGMT');
insert into Student values ('26186666','Warren','Buffet','bsbuffet','28266027','2023',null,'MGMT');
insert into Student values ('28435018','David','Decker','bsdecker','27619435','2024',null,'MGMT');
insert into Student values ('66666666','Ferris','Bueller','bsbueller','28282727','2023',null,'MGMT');
insert into Student values ('15000655','Steve','Jobs','csjobs','26232244','2023',null,'COMP');
insert into Student values ('15085942','Bill','Gates','csgates','25678679','2024',null,'COMP');
insert into Student values ('28834512','Isaac','Newton','manewton','22861987','2023',null,'MATH');
insert into Student values ('28918856','Alan','Turing','maturing','26679834','2023',null,'MATH');
insert into Student values ('29873381','Nikola','Tesla','eetesla','25671983','2023',null,'ELEC');
insert into Student values ('13782973','Edith','Clarke','eeclarke','28340180','2023',null,'ELEC');
insert into Student values ('18792018','Elon','Musk','bsmusk','28659910','2024',null,'MGMT');
...
insert into EnrollsIn values ('13782973','COMP 4021',77.2);
...
insert into EnrollsIn values ('26186666','ELEC 3100',95.1);
...
insert into EnrollsIn values ('13782973','HUMA 1020',72.1);
